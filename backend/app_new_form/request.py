...
# ID로 발주 내역 조회
# ============================================
@app.get("/select_request/{request_seq}")
...
# 팀장 결재 처리
# ============================================
@app.post("/approve_request_manager/{request_seq}")
...
# 이사 결재 처리
# ============================================
@app.post("/approve_request_director/{request_seq}")
...
# 발주 내역 삭제
# ============================================
@app.delete("/delete_request/{request_seq}")
