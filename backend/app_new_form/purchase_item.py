...
# ID로 구매 내역 조회
# ============================================
@app.get("/select_purchase_item/{purchase_item_seq}")
...
# 고객별 구매 내역 조회
# ============================================
@app.get("/select_purchase_items_by_user/{user_seq}")
...
# ============================================
@app.get("/select_purchase_items_by_tnum/{b_tnum}")
...
# 구매 내역 삭제
# ============================================
@app.delete("/delete_purchase_item/{purchase_item_seq}")
