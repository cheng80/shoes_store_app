...
# 전체 색상 카테고리 조회
# ============================================
@app.get("/select_color_categories")
...
# ID로 색상 카테고리 조회
# ============================================
@app.get("/select_color_category/{color_category_seq}")
...
# 색상 카테고리 추가
# ============================================
@app.post("/insert_color_category")
...
# 색상 카테고리 수정
# ============================================
@app.post("/update_color_category")
...
# 색상 카테고리 삭제
# ============================================
@app.delete("/delete_color_category/{color_category_seq}")
