...
# 전체 사이즈 카테고리 조회
# ============================================
@app.get("/select_size_categories")
...
# ID로 사이즈 카테고리 조회
# ============================================
@app.get("/select_size_category/{size_category_seq}")
...
# 사이즈 카테고리 삭제
# ============================================
@app.delete("/delete_size_category/{size_category_seq}")
