...
# 전체 성별 카테고리 조회
# ============================================
@app.get("/select_gender_categories")
...
# ID로 성별 카테고리 조회
# ============================================
@app.get("/select_gender_category/{gender_category_seq}")
...
# 성별 카테고리 추가
# ============================================
@app.post("/insert_gender_category")
...
# 성별 카테고리 수정
# ============================================
@app.post("/update_gender_category")
...
# 성별 카테고리 삭제
# ============================================
@app.delete("/delete_gender_category/{gender_category_seq}")
