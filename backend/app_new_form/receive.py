...
# ID로 입고 내역 조회
# ============================================
@app.get("/select_receive/{receive_seq}")
...
# 제품별 입고 내역 조회
# ============================================
@app.get("/select_receives_by_product/{product_seq}")
...
# 입고 처리 (날짜 업데이트)
# ============================================
@app.post("/process_receive/{receive_seq}")
...
# 입고 내역 삭제
# ============================================
@app.delete("/delete_receive/{receive_seq}")
