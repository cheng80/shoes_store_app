...
async def update_user(
    ...
    try:
        ...
        sql = """
            ...
            WHERE u_seq=%s
        """
        curs.execute(sql, (u_id, u_password, u_name, u_phone, u_seq))
        conn.commit()
        conn.close()
        return {"result": "OK"}
    except Exception as e:
...
# ============================================
@app.post("/update_user_with_image")
async def update_user_with_image(
    ...
    try:
        ...
        sql = """
            ...
            WHERE u_seq=%s
        """
        curs.execute(sql, (u_id, u_password, u_name, u_phone, image_data, u_seq))
        conn.commit()
        conn.close()
        return {"result": "OK"}
    except Exception as e:
...
# ============================================
@app.get("/view_user_profile_image/{user_seq}")
...
# 프로필 이미지 삭제
# ============================================
@app.delete("/delete_user_profile_image/{user_seq}")
...
# 고객 삭제
# ============================================
@app.delete("/delete_user/{user_seq}")
