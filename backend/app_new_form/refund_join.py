...
app = FastAPI(title="Refund JOIN API")
ipAddress = "127.0.0.1"
port = 8000
...
# Refund + User + Staff + Pickup + PurchaseItem + Product + Branch
# ============================================
@app.get("/refunds/{refund_seq}/with_details")
...
# ============================================
@app.get("/refunds/{refund_seq}/full_detail")
...
# 고객별 Refund 목록
# ============================================
@app.get("/refunds/by_user/{user_seq}/with_details")
...
# 직원별 처리한 Refund 목록
# ============================================
@app.get("/refunds/by_staff/{staff_seq}/with_details")
...
if __name__ == "__main__":
    import uvicorn
    print(f"🚀 Refund JOIN API 서버 시작")
    print(f"   서버 주소: http://{ipAddress}:{port}")
    print(f"   Swagger UI: http://{ipAddress}:{port}/docs")
    print(f"")
    print(f"   엔드포인트:")
    print(f"   - GET /refunds/{{refund_seq}}/with_details")
    print(f"   - GET /refunds/{{refund_seq}}/full_detail")
    print(f"   - GET /refunds/by_user/{{user_seq}}/with_details")
    print(f"   - GET /refunds/by_staff/{{staff_seq}}/with_details")
