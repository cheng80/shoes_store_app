"""
PurchaseItem 복합 쿼리 API (Model 방식)
- PurchaseItem 중심의 JOIN 쿼리들
- PurchaseItem + Product + ProductBase + Manufacturer
- GET 요청만 있어 Model 정의 불필요

개별 실행: python purchase_items_join.py
"""
...
# ============================================
@app.get("/purchase_items/{item_id}/with_product")
...
# ============================================
@app.get("/purchase_items/by_pcid/{pcid}/with_product")
...
# ============================================
@app.get("/purchase_items/{item_id}/full_detail")
...
# ============================================
@app.get("/purchase_items/by_pcid/{pcid}/full_detail")
...
# 주문 요약 정보 (집계)
# ============================================
@app.get("/purchase_items/summary/{pcid}")
...
if __name__ == "__main__":
    ...
    print(f"")
    print(f"   엔드포인트:")
    print(f"   - GET /purchase_items/{{item_id}}/with_product")
    print(f"   - GET /purchase_items/by_pcid/{{pcid}}/with_product")
    print(f"   - GET /purchase_items/{{item_id}}/full_detail")
    print(f"   - GET /purchase_items/by_pcid/{{pcid}}/full_detail")
    print(f"   - GET /purchase_items/summary/{{pcid}}")
