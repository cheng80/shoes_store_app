"""
ProductBase API - 제품 기본정보 CRUD (Model 방식)
...
# ============================================
# ProductBase 추가 (JSON Body)
# ============================================
@app.post("/insert_product_base")
async def insert_product_base(product_base: ProductBaseCreate):
    try:
        conn = connect_db()
        curs = conn.cursor()
        sql = """
        ...
        """
        curs.execute(sql, (
            product_base.pName, product_base.pDescription, product_base.pColor,
            product_base.pGender, product_base.pStatus, product_base.pCategory, product_base.pModelNumber
        ))
        conn.commit()
...
# ============================================
# ProductBase 수정 (JSON Body)
# ============================================
@app.post("/update_product_base")
async def update_product_base(product_base: ProductBaseUpdate):
    try:
        conn = connect_db()
        curs = conn.cursor()
        sql = """
